        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed max-w-md">
              Leading provider of industrial machinery installation,
              maintenance, and repair services. Specialized in Müller Martini,
              Kolbus, and Hörauf printing equipment.
            </p>
          </div>
